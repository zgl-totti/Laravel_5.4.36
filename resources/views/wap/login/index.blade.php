    ...
    {{--<script type="text/javascript">
        $(function(){
            $('.loginbtn').click(function(){
                $.post("{{url('wap/login')}}",$('#form1').serialize(),function(res){
                    if(res.code==1){
                        layer.msg(res.info,{icon:6,time:2000},function(){
                            location="{{url('wap/index')}}";
                        })
                    }else{
...
<div class="loginbody">
    ...
    <div class="loginbox loginbox1">
        <form action="{{url('wap/login')}}" method="post" id="form1">
            ...
            <ul>
                ...
                <li class="yzm">
                    ...
                    <cite><img src="{{url('admin/captcha/1')}}" width="118" height="46" style="cursor:pointer" onclick="this.src='{{url('admin/captcha',rand())}}'" /> </cite>
                </li>
                <li>
