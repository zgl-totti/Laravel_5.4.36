...
<div class="content" style="background: rgb(255,253,204)">
    ...
    <div class="Jmain">
                    ...
                    <if condition="$val['status'] eq 0">
                        ...
                        <li>
                            ...
                            <div class="hotUl_main shiwu">
                                <img width="210" src="/Uploads/{$val['ginfo']['pic']}" alt=""/>
                            </div>
                            <div class="duihuan"><a href="{:U('Goods/goodsDetail',array('gid'=>$val['ginfo']['id'],'jf'=>$val['needjf']))}"><h2>{:mb_substr($val['ginfo']['goodsname'],0,15,'utf-8')}</h2></a></div>
                        </li>
                    </if>
                </volist>
            </ul>
        ...
        <div class="list">
            ...
            <div class="lp">
                <ul>
                    <volist name="list1" id="val1">
                        <li>
                            <div class="jf">{$val1.needjf}积分</div>
                            <div class="hotUl_main xuni">
                                <span class="ubb">{$val1.getub}</span>
                                <br/><span class="ub">U币</span>
                            </div>
                            <div class="duihuan"><h2>立即兑换</h2></div>
                        </li>
            ...
            <div class="lp" style="display:none">
                <ul>
                    <volist name="list2" id="val2">
                        <li>
                            <div class="jf">{$val2.needjf}积分</div>
                            <div class="hotUl_main shiwu">
                                <img width="210" src="/Uploads/{$val2['ginfo']['pic']}" alt=""/>
                            </div>
                            <div class="duihuan"><a href="{:U('Goods/goodsDetail',array('gid'=>$val2['ginfo']['id'],'jf'=>$val2['needjf']))}"><h2>{:mb_substr($val2['ginfo']['goodsname'],0,15,'utf-8')}</h2></a></div>
                        </li>
                    </volist>
                </ul>
                <div class="clear"></div>
            ...
            <div class="lp" style="display:none">
                <ul>
                    <volist name="list4" id="val4">
                        <if condition="$val4['status'] eq 0">
                            <li>
                                <div class="jf">{$val4.needjf}积分</div>
                                <div class="hotUl_main xuni">
                                    <span class="ubb">{$val4.getub}</span>
                                    <br/><span class="ub">U币</span>
                                </div>
                                <div class="duihuan"><h2>立即兑换</h2></div>
                            </li>
                            ...
                            <li>
                                <div class="jf">{$val4.needjf}积分</div>
                                <div class="hotUl_main shiwu">
                                    <img width="210" src="/Uploads/{$val4['ginfo']['pic']}" alt=""/>
                                </div>
                                <div class="duihuan"><a href="{:U('Goods/goodsDetail',array('gid'=>$val4['ginfo']['id'],'jf'=>$val4['needjf']))}"><h2>{:mb_substr($val4['ginfo']['goodsname'],0,15,'utf-8')}</h2></a></div>
                            </li>
                        </if>
                    </volist>
                </ul>
        ...
        <div class="cfoot" style="width: 674px;margin: 0 auto">
            <div class="detail">
                ...
                <div style="padding: 10px;background: orangered">
                    <volist name="jinfo" id="jval">
                        <if condition="$jval.lx eq 2">
                            <p style="margin-left: 100px"><span style="color:#000;line-height:20px;margin-right: 10px;display: inline-block;width: 20px;height: 20px;border-radius: 50%;background:rgb(254,206,70);text-align: center ">{$i}</span>{$jval.prize}：{$jval.num}U币</p>
                            <else/>
                            <p style="margin-left: 100px"><span style="color:#000;line-height:20px;margin-right: 10px;display: inline-block;width: 20px;height: 20px;border-radius: 50%;background:rgb(254,206,70);text-align: center ">{$i}</span>{$jval.prize}：{$jval.num}积分</p>
                        </if>
                    </volist>
                </div>
            </div>
            <div style="width: 336px;background: #fff;float: left" class="cj_log">
                ...
                <ul id="logUUL" style="width: 300px;height: 240px;margin: 0 auto;background: rgb(205,39,60);padding: 10px 0">
                    <volist name="log" id="vallog">
                        <li style="padding:0 5px;background: rgb(217,64,82);margin: 10px 20px;width: 260px;color: #fff;height: 25px;line-height: 25px;text-align: center"><span style="float: left;">{$vallog['minfo']['username']}</span><span>{$vallog['prize']}</span><span style="float: right;">{:date('Y-m-d H:i:s',$vallog['addtime'])}</span></li>
                    </volist>
                </ul>
            </div>
        </div>
