						...
						<form action="#" method="get" id="tocountForm">
							...
							<div class="am-tab-panel am-fade am-in am-active" id="tab1">
								<div class="order-top" style=" background: #c2ccd1;padding-top: 10px;">
									...
									<div class="th th-change" style="margin-left: 64px">
										<td class="td-inner">交易操作</td>
									</div>
								</div>
								<div class="order-main">
									<div class="order-list" style="width: 998px;">
										<!--交易成功-->
												...
												<div class="order-content">
													<div class="order-left">
														<ul class="item-list">
															...
															<li class="td td-item">
																<div class="item-pic">
																	<a href="{{url('goods/index',['gid'=>$v['id'],'status'=>3])}}" class="J_MakePoint">
																		<img src="{{url('uploads')}}/{{$v['pic']}}" width="78px;" class="itempic J_ItemImg">
																	</a>
																</div>
																<div class="item-info">
															...
															<li class="td td-number" style="padding-top: 25px;">
																<div class="item-number" style="width: 70px">
																	<a class="jian" style="display:inline-block;width:20px;border:1px solid #ccc" href="javascript:;">-</a><input readonly value="{{$v['buynum']}}" name="num{{$v['id']}}" style="text-align:center;outline: none;width: 25px;height: 15px;border: 0"/><a class="jia" style="display:inline-block;width:20px;border:1px solid #ccc" href="javascript:;">+</a>
																</div>
															</li>
														</ul>
													</div>
													<div class="order-right">
														<li class="td td-amount">
															<div class="item-amount">
																...
																<p>含运费：<span class="yunfei">10.00</span></p>
															</div>
														</li>
														<div class="move-right">
															<li class="td td-change">
																<a href="javascript:;" style="margin-left: 56px" class="delgoodsBycart" gid="{{$v['id']}}"><div class="am-btn am-btn-danger anniu">删除商品</div></a>
															</li>
														</div>
													</div>
												</div>
								...
								<div class="cart-count">
									<div class="cart-list-foot">
										...
										<div class="cart-list-r"><span class="total">共计￥:0</span><a href="javascript:;" id="tocount" >去结算>></a></div>
									</div>
								</div>
							</div>
						</form>
