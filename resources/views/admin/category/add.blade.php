...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(e) {
            ...
            $('.btn').click(function(){
                $.post("{{url('admin/category_add')}}",$('#form1').serialize(),function(res){
                    if(res.code==1){
                        layer.msg(res.body,{icon:6,time:1000},function(){
                            location.href="{{url('admin/category_add')}}";
                        })
                    }else{
        ...
        <div id="tab1" class="tabson">
            <ul class="forminfo">
                <form action="#" method="post" id="form1">
                    ...
                    <li><label>分类名称<b>*</b></label><input name="categoryname" type="text" class="dfinput" placeholder="请输入分类名称"  style="width:200px;"/></li>
                    ...
                    <li><label>&nbsp;</label><input type="submit" class="btn" value="添加分类"/></li>
                </form>
            </ul>
        </div>
    </div>
