        ...
        $(document).ready(function(e) {
            ...
            $("#form1").submit(function(){
                $("#form1").ajaxSubmit(function(res){
                    if(res.status){
                        layer.alert(res.info,function(){location.href='{:U("index")}'});
                    }else{
            ...
            $(".dfinput").click(function(){
                layer.alert("禁止修改品牌名称");
            })
        });
    </script>
</head>
...
<div class="formbody">
    <div id="usual1" class="usual">
        <div id="tab1" class="tabson">
            <ul class="forminfo">
                <form action="{{url('admin/brand_edit',['status'=>500])}}" method="post" id="form1" enctype="multipart/form-data">
                    <li><label>品牌名称<b>*</b></label><input name="brandname" readonly type="text" class="dfinput" value="{{$info['brandname']}}" style="width:200px;"/></li>
                    <!--<li><label>品牌logo<b>*</b></label><input name="logo" type="file" class="dfinput" style="width:200px;"/></li>-->
                    <li>
                    ...
                    <input type="hidden" value="{{$info['id']}}" name="bid"/>
                    <input type="hidden" name="_token" value="{{csrf_token()}}" />
                    <li><label>&nbsp;</label><input style="border-radius:4px;font-size:18px;background:#00b7ee;" type="submit" class="btn" value="确认修改品牌"/></li>
                </form>
            </ul>
        </div>
    </div>
