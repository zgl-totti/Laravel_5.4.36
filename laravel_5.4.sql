/*
 ...
 Source Schema         : laravel_5.4

 Target Server Type    : MySQL
 Target Server Version : 50710
 File Encoding         : 65001

 Date: 08/05/2018 09:26:37
*/
...
CREATE TABLE `yhyg_account`  (
  ...
  `money` float(8, 0) UNSIGNED NULL DEFAULT NULL,
  `addtime` int(10) UNSIGNED NULL DEFAULT NULL,
  `action` int(5) NULL DEFAULT 1 COMMENT '1为消费，2为充值,3积分兑换',
...
-- ----------------------------
INSERT INTO `yhyg_activity_pic` VALUES (1, 1, '2016-11-02/581950e326ce6.png');
INSERT INTO `yhyg_activity_pic` VALUES (2, 1, '2016-11-02/581950e3464d6.jpg');
INSERT INTO `yhyg_activity_pic` VALUES (3, 2, '2016-11-02/58195134b9742.jpg');
INSERT INTO `yhyg_activity_pic` VALUES (4, 2, '2016-11-02/58195134dfc93.jpg');
INSERT INTO `yhyg_activity_pic` VALUES (5, 3, '2016-11-02/5819517fe866e.jpg');
INSERT INTO `yhyg_activity_pic` VALUES (6, 3, '2016-11-02/581951800da74.png');
INSERT INTO `yhyg_activity_pic` VALUES (7, 4, '2016-11-02/581951daa4d23.png');
INSERT INTO `yhyg_activity_pic` VALUES (8, 4, '2016-11-02/581951dabe369.png');
INSERT INTO `yhyg_activity_pic` VALUES (18, 5, '2016-11-17/582d899f58b28.png');
INSERT INTO `yhyg_activity_pic` VALUES (19, 5, '2016-11-05/581d880f6347c.png');
...
CREATE TABLE `yhyg_ad`  (
  ...
  `status` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '1' COMMENT '0关闭1开启',
  `images` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `content` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `location` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0轮播图' COMMENT '0轮播图1活动图2商城头条图3轮播内容图',
  `title` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '商城头条标题',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `yhyg_admin`  (
  ...
  `status` tinyint(2) NULL DEFAULT 1 COMMENT ' 0冻结1 正常',
  `lasttime` int(10) NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `yhyg_admin` VALUES (1, 'admin', 'e10adc3949ba59abbe56e057f20f883e', 2016, '127.0.0.1', 1, 1524706949, '2016-11-09/582300701c209.jpg', '0');
...
CREATE TABLE `yhyg_admin_nav`  (
  ...
  `pid` tinyint(3) UNSIGNED NULL DEFAULT 0,
...
CREATE TABLE `yhyg_after_status`  (
  ...
  `statusname` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `memberopt` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `yhyg_auth_group`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 17 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户组表' ROW_FORMAT = Dynamic;
...
) ENGINE = MyISAM AUTO_INCREMENT = 62 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户组明细表' ROW_FORMAT = Fixed;
...
) ENGINE = MyISAM AUTO_INCREMENT = 126 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '规则表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `yhyg_bargain`  (
  ...
  `cutprice` int(10) NULL DEFAULT 0 COMMENT '优惠价',
  `cut` int(11) NULL DEFAULT 0 COMMENT '砍价',
  `status` tinyint(2) NULL DEFAULT 0 COMMENT '1：已砍 0:未砍',
  `price` float(8, 2) NULL DEFAULT NULL,
  `cname` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '分类名',
  `bname` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '品牌名',
  `addtime` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `edittime` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `yhyg_bargain` VALUES (2, 7, 0, 0, 0, 3199.00, '格力壁挂式空调', '格力', NULL, NULL);
INSERT INTO `yhyg_bargain` VALUES (3, 19, 0, 0, 0, 3699.00, '小米电视', '小米', NULL, NULL);
INSERT INTO `yhyg_bargain` VALUES (4, 3, 0, 0, 0, 1798.00, '飞利浦电视', '飞利浦', NULL, NULL);
INSERT INTO `yhyg_bargain` VALUES (5, 2, 0, 0, 0, 5499.00, '三星电视', '三星', NULL, NULL);
INSERT INTO `yhyg_bargain` VALUES (6, 5, 0, 0, 0, 6008.00, '创维电视', '创维', NULL, NULL);
INSERT INTO `yhyg_bargain` VALUES (7, 20, 0, 0, 0, 7699.00, '奥克斯空调', '奥克斯', NULL, NULL);
INSERT INTO `yhyg_bargain` VALUES (8, 4, 0, 0, 0, 3399.00, '海信电视', '海信', NULL, NULL);
INSERT INTO `yhyg_bargain` VALUES (9, 1, 0, 0, 0, 4699.00, '索尼电视', '索尼', NULL, NULL);
INSERT INTO `yhyg_bargain` VALUES (10, 43, 0, 0, 0, 2899.00, '格力壁挂式空调', '格力', NULL, NULL);
...
INSERT INTO `yhyg_bargain` VALUES (13, 45, 0, 0, 0, 3699.00, '格力壁挂式空调', '格力', NULL, NULL);
INSERT INTO `yhyg_bargain` VALUES (14, 18, 0, 0, 0, 2180.00, '海尔酒柜冰箱', '海尔', NULL, NULL);
INSERT INTO `yhyg_bargain` VALUES (15, 9, 0, 0, 0, 4999.00, '美的柜式空调', '美的', NULL, NULL);
INSERT INTO `yhyg_bargain` VALUES (16, 16, 0, 0, 0, 949.00, '海尔双门冰箱', '海尔', NULL, NULL);
INSERT INTO `yhyg_bargain` VALUES (17, 41, 0, 0, 0, 2399.00, '海尔壁挂式空调', '海尔', NULL, NULL);
INSERT INTO `yhyg_bargain` VALUES (18, 12, 0, 0, 0, 2699.00, '海尔滚筒洗衣机', '海尔', NULL, NULL);
INSERT INTO `yhyg_bargain` VALUES (19, 40, 0, 0, 0, 3699.00, '海尔壁挂式空调', '海尔', NULL, NULL);
INSERT INTO `yhyg_bargain` VALUES (20, 13, 0, 0, 0, 3999.00, '海尔多门冰箱', '海尔', NULL, NULL);
INSERT INTO `yhyg_bargain` VALUES (23, 32, 0, 0, 0, 2699.00, '长虹电视', '长虹', NULL, NULL);
INSERT INTO `yhyg_bargain` VALUES (24, 15, 0, 0, 0, 1298.00, '美的三门冰箱', '美的', NULL, NULL);
...
INSERT INTO `yhyg_bargain` VALUES (27, 44, 0, 0, 0, 2198.00, '格力壁挂式空调', '格力', NULL, NULL);
INSERT INTO `yhyg_bargain` VALUES (28, 42, 0, 0, 0, 1800.00, '海尔壁挂式空调', '海尔', NULL, NULL);
INSERT INTO `yhyg_bargain` VALUES (29, 33, 0, 0, 0, 3500.00, '长虹电视', '长虹', NULL, NULL);
INSERT INTO `yhyg_bargain` VALUES (30, 38, 0, 0, 0, 2599.00, NULL, NULL, NULL, NULL);
...
CREATE TABLE `yhyg_brand`  (
  `id` tinyint(3) UNSIGNED NOT NULL AUTO_INCREMENT,
  `brandname` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `yhyg_cj`  (
  `id` int(11) NOT NULL,
  `prize` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '奖项名称',
  `v` int(11) NOT NULL COMMENT '设置中奖几率',
  `num` int(11) NULL DEFAULT NULL,
  `lx` tinyint(5) NULL DEFAULT NULL COMMENT '1为积分，2为U币,3为谢谢参与',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `yhyg_cjlog`  (
  ...
  `prize` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `yhyg_comment`  (
  `id` smallint(5) UNSIGNED NOT NULL AUTO_INCREMENT,
  `mid` smallint(5) NULL DEFAULT NULL COMMENT 'member ID ',
  `content` varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '评论内容（100字以内）',
  `edittime` int(10) UNSIGNED NOT NULL COMMENT '评论时间',
  `gid` smallint(5) NOT NULL COMMENT '商品id',
  `sid` tinyint(1) NULL DEFAULT NULL COMMENT '1:好评；2：中评;3:差评;4:未评价',
  `oid` smallint(5) NULL DEFAULT NULL,
  `response` varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '回复 的内容',
  `restime` int(10) NULL DEFAULT NULL COMMENT '回复时间',
  `photo` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `yhyg_goods`  (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `goodsname` varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `cname` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `cid` tinyint(3) UNSIGNED NOT NULL,
  `markeprice` float(8, 2) UNSIGNED NULL DEFAULT NULL,
  ...
  `bid` tinyint(5) UNSIGNED NULL DEFAULT NULL,
  `hot` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '选购热点',
  `credit` int(10) NULL DEFAULT 1000,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `yhyg_goods_pic`  (
  ...
  `picname` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `yhyg_jorder`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `ordersyn` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '订单号',
  `mid` int(11) UNSIGNED NULL DEFAULT NULL,
  `scid` int(11) NULL DEFAULT NULL,
  `orderprice` float UNSIGNED NULL DEFAULT NULL COMMENT '总价',
  `orderstatus` int(11) NULL DEFAULT NULL,
  `addtime` int(11) UNSIGNED NULL DEFAULT NULL COMMENT '提交时间',
...
CREATE TABLE `yhyg_jshop`  (
  ...
  `getUB` int(11) NULL DEFAULT NULL,
  `status` int(11) NULL DEFAULT NULL COMMENT '0为虚拟礼品，1为实物礼品',
  `gid` int(11) NULL DEFAULT NULL,
  `zd` int(5) NULL DEFAULT 0 COMMENT '0为普通，1为置顶',
...
-- ----------------------------
INSERT INTO `yhyg_jshop` VALUES (1, 5001, 500, 0, NULL, 1, 1478769491);
INSERT INTO `yhyg_jshop` VALUES (2, 10000, 1000, 0, NULL, 1, 1478769491);
INSERT INTO `yhyg_jshop` VALUES (3, 20000, 2000, 0, NULL, 1, 1478769491);
...
INSERT INTO `yhyg_jshop` VALUES (17, 1000, 1000, 0, NULL, 0, NULL);
INSERT INTO `yhyg_jshop` VALUES (18, 1000, NULL, 1, 5, 0, NULL);
...
CREATE TABLE `yhyg_letter`  (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `title` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '积分兑换',
  `content` varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `addtime` int(11) NOT NULL,
...
INSERT INTO `yhyg_letter` VALUES (24, '积分抽奖', '在积分抽奖活动抽中了八等奖获得30积分', 1480322263, 7, 1);
...
INSERT INTO `yhyg_letter` VALUES (33, '积分抽奖', '在积分抽奖活动抽中了七等奖获得40积分', 1480640491, 7, 1);
...
CREATE TABLE `yhyg_member`  (
  ...
  `addtime` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '添加时间',
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `sex` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '1为男，2为女',
  ...
  `active` varchar(4) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '1' COMMENT '会员管理，0为禁用，1为正常',
  `integral` int(11) UNSIGNED NULL DEFAULT 0 COMMENT '用户积分',
  `balance` int(11) NULL DEFAULT 0 COMMENT '账户余额',
  `touxiang` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `paypwd` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '支付密码',
  `isnew` tinyint(2) NULL DEFAULT 0 COMMENT '0为新用户，1为老用户',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `yhyg_member` VALUES (5, '123456', 'e10adc3949ba59abbe56e057f20f883e', '1477903067', '415', '男', '2016-11-10', '13283871582', '25784524', 0, 1, '1', 1665, 8792, 'uploads/2016-11-24/5836770b0edfa.png', 'e10adc3949ba59abbe56e057f20f883e', 0);
...
INSERT INTO `yhyg_member` VALUES (7, 'admin', 'e10adc3949ba59abbe56e057f20f883e', '1477903160', '大帅哥', '男', '2016-11-4', '15738776352', '5645441@qq.com', 88211, 1, '1', 88560, 9958309, 'uploads/2016-11-25/5837d7b9b0a3b.jpg', 'e10adc3949ba59abbe56e057f20f883e', 1);
...
-- ----------------------------
-- Table structure for yhyg_migrations
-- ----------------------------
DROP TABLE IF EXISTS `yhyg_migrations`;
CREATE TABLE `yhyg_migrations`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of yhyg_migrations
-- ----------------------------
INSERT INTO `yhyg_migrations` VALUES (1, '2014_10_12_000000_create_users_table', 1);
INSERT INTO `yhyg_migrations` VALUES (2, '2014_10_12_100000_create_password_resets_table', 1);
INSERT INTO `yhyg_migrations` VALUES (3, '2016_06_01_000001_create_oauth_auth_codes_table', 1);
INSERT INTO `yhyg_migrations` VALUES (4, '2016_06_01_000002_create_oauth_access_tokens_table', 1);
INSERT INTO `yhyg_migrations` VALUES (5, '2016_06_01_000003_create_oauth_refresh_tokens_table', 1);
INSERT INTO `yhyg_migrations` VALUES (6, '2016_06_01_000004_create_oauth_clients_table', 1);
INSERT INTO `yhyg_migrations` VALUES (7, '2016_06_01_000005_create_oauth_personal_access_clients_table', 1);
INSERT INTO `yhyg_migrations` VALUES (8, '2018_01_30_154622_create_totti_table', 1);
INSERT INTO `yhyg_migrations` VALUES (9, '2018_01_30_154828_alter_totti_table', 1);

-- ----------------------------
-- Table structure for yhyg_oauth_access_tokens
-- ----------------------------
DROP TABLE IF EXISTS `yhyg_oauth_access_tokens`;
CREATE TABLE `yhyg_oauth_access_tokens`  (
...
-- ----------------------------
-- Records of yhyg_oauth_access_tokens
-- ----------------------------
INSERT INTO `yhyg_oauth_access_tokens` VALUES ('26d48373c6a29c8e8a928e4c327a0592037a7144d1ab8211b2fb518ad82c2314ee39e310c7245c71', 2, 1, 'MyApp', '[]', 0, '2018-03-27 10:18:22', '2018-03-27 10:18:22', '2019-03-27 10:18:22');
INSERT INTO `yhyg_oauth_access_tokens` VALUES ('70b447c190a2caf4afffc6a29dda1b3e04ba953ce25225417169bfcd11b40f7e0bf3432b93ea33d3', 2, 1, 'MyApp', '[]', 0, '2018-03-27 10:09:54', '2018-03-27 10:09:54', '2019-03-27 10:09:54');
INSERT INTO `yhyg_oauth_access_tokens` VALUES ('89b27f018ba6747d0a7df2def9c40635e78ab845ea5ca845fc16c3bdf66b961d731f7d4e2dd51ddd', 1, 1, 'MyApp', '[]', 0, '2018-03-26 17:28:50', '2018-03-26 17:28:50', '2019-03-26 17:28:50');
INSERT INTO `yhyg_oauth_access_tokens` VALUES ('a5b1c9bb7a19fdc3897ea1cccaf8ac2ad38d13f7de02a32ff3ca86bd1dca9f9db7a1a4dc52105f95', 2, 1, 'MyApp', '[]', 0, '2018-03-27 10:11:49', '2018-03-27 10:11:49', '2019-03-27 10:11:49');
INSERT INTO `yhyg_oauth_access_tokens` VALUES ('b627ee13c29b32cac114967fca190847a8d37c75cc53bbb915c9057314068d1af1c441f86467c07a', 1, 1, 'MyApp', '[]', 0, '2018-03-26 17:33:22', '2018-03-26 17:33:22', '2019-03-26 17:33:22');
INSERT INTO `yhyg_oauth_access_tokens` VALUES ('b68d56fe8c7a7b06bc98d3560c069df48f05cc41a19111fa3e7d500c2f791c5e4984f4390d50d6db', 4, 1, 'MyApp', '[]', 0, '2018-03-27 09:53:45', '2018-03-27 09:53:45', '2019-03-27 09:53:45');
INSERT INTO `yhyg_oauth_access_tokens` VALUES ('bbcaa46e5300e8fe074000ad8b60d2756ef94cbe4e0dc209c78df81698eecbdf74e2ae9220df0a8e', 4, 1, 'MyApp', '[]', 0, '2018-03-27 09:53:26', '2018-03-27 09:53:26', '2019-03-27 09:53:26');

-- ----------------------------
-- Table structure for yhyg_oauth_auth_codes
-- ----------------------------
DROP TABLE IF EXISTS `yhyg_oauth_auth_codes`;
CREATE TABLE `yhyg_oauth_auth_codes`  (
  `id` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- ----------------------------
-- Table structure for yhyg_oauth_clients
-- ----------------------------
DROP TABLE IF EXISTS `yhyg_oauth_clients`;
CREATE TABLE `yhyg_oauth_clients`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NULL DEFAULT NULL,
...
-- ----------------------------
-- Records of yhyg_oauth_clients
-- ----------------------------
INSERT INTO `yhyg_oauth_clients` VALUES (1, NULL, 'Laravel Personal Access Client', 'gjzWnzvxc1MdETTiiYXIC0M6jev4E9KAWMc4Ml8G', 'http://localhost', 1, 0, 0, '2018-03-08 13:59:15', '2018-03-08 13:59:15');
INSERT INTO `yhyg_oauth_clients` VALUES (2, NULL, 'Laravel Password Grant Client', 'l1gIdY6UCrF0HlLcz1MFK0GP9H5sOLHYPfMfF172', 'http://localhost', 0, 1, 0, '2018-03-08 13:59:15', '2018-03-08 13:59:15');

-- ----------------------------
-- Table structure for yhyg_oauth_personal_access_clients
-- ----------------------------
DROP TABLE IF EXISTS `yhyg_oauth_personal_access_clients`;
CREATE TABLE `yhyg_oauth_personal_access_clients`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `client_id` int(11) NOT NULL,
  `created_at` timestamp(0) NULL DEFAULT NULL,
  `updated_at` timestamp(0) NULL DEFAULT NULL,
...
-- ----------------------------
-- Records of yhyg_oauth_personal_access_clients
-- ----------------------------
INSERT INTO `yhyg_oauth_personal_access_clients` VALUES (1, 1, '2018-03-08 13:59:15', '2018-03-08 13:59:15');

-- ----------------------------
-- Table structure for yhyg_oauth_refresh_tokens
-- ----------------------------
DROP TABLE IF EXISTS `yhyg_oauth_refresh_tokens`;
CREATE TABLE `yhyg_oauth_refresh_tokens`  (
  `id` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `yhyg_order` VALUES (105, '201612024708629531', 7, 31, 349, 4, 1480660782, '');
...
CREATE TABLE `yhyg_order_goods`  (
  ...
  `gid` int(10) NULL DEFAULT NULL,
  `buynum` int(10) NULL DEFAULT NULL,
  `gidprice` int(10) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `yhyg_order_status`  (
  ...
  `memberopt` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `adminopt` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
-- Table structure for yhyg_password_resets
-- ----------------------------
DROP TABLE IF EXISTS `yhyg_password_resets`;
CREATE TABLE `yhyg_password_resets`  (
...
CREATE TABLE `yhyg_qd`  (
  ...
  `total` tinyint(5) NULL DEFAULT 0 COMMENT '用户本月签到总数',
  `str` varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '用户签到日期字符串',
  `clear` tinyint(2) NULL DEFAULT NULL COMMENT '代表下一个要清除的月',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `yhyg_site`  (
  ...
  `mid` int(11) UNSIGNED NULL DEFAULT NULL COMMENT '用户',
  `phone` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `ps` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `qs` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `ws` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `xyd` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `addtime` int(255) NULL DEFAULT NULL,
  `active` tinyint(4) UNSIGNED NULL DEFAULT 0 COMMENT '0默认，不启用地址，1启用地址',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
-- Table structure for yhyg_totti
-- ----------------------------
DROP TABLE IF EXISTS `yhyg_totti`;
CREATE TABLE `yhyg_totti`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `club` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp(0) NULL DEFAULT NULL,
  `updated_at` timestamp(0) NULL DEFAULT NULL,
  `age` int(11) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `totti_name_unique`(`name`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for yhyg_users
-- ----------------------------
DROP TABLE IF EXISTS `yhyg_users`;
CREATE TABLE `yhyg_users`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `email` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- ----------------------------
-- Records of yhyg_users
-- ----------------------------
INSERT INTO `yhyg_users` VALUES (1, 'totti_10', 'totti_10@qq.com', '$2y$10$Itz8dF0WLkYK7E.NjDWPX.9MJdWOdtjtI2OjxzX3MLqYQxpAgzutG', NULL, '2018-03-20 10:39:23', '2018-03-20 10:39:23');
INSERT INTO `yhyg_users` VALUES (2, 'admin_10', 'admin_10@qq.com', '$2y$10$m1KU49Yral3P.BaNQ3ZRruu.2Jfh1jp5/JQpUasamdqcd4XuFUcbO', NULL, '2018-03-20 11:14:15', '2018-03-20 11:14:15');
INSERT INTO `yhyg_users` VALUES (3, 'roma_10', 'roma_10@qq.com', '$2y$10$HD2iEUsIz07JF.XWkhL08uuGnL/KzFuPY5aCFz0LPZPxFfG7o9v.O', NULL, '2018-03-20 11:26:14', '2018-03-20 11:26:14');
INSERT INTO `yhyg_users` VALUES (4, 'spur_10', 'spur_10@qq.com', '$2y$10$rf641fiVs8bKtN5kbVIQsOLDCjdPlCZGH6c/Ch7u/CnMfwBI2CL/S', NULL, '2018-03-21 14:09:14', '2018-03-21 14:09:14');
INSERT INTO `yhyg_users` VALUES (5, 'calf_10', 'calf_10@qq.com', '$2y$10$FeWGH4UgQcnbEH3603IDe.S3hZiuX21t0xJvFmNkDdOi/IG5aPQaO', NULL, '2018-03-21 14:11:02', '2018-03-21 14:11:02');
INSERT INTO `yhyg_users` VALUES (6, 'rocket_10', 'rocket_10@qq.com', '$2y$10$PiZ6VbMG9voW1jQRIZclzOclv9uRqw1WTa7Z.wLsPyE1hmWAif4HS', NULL, '2018-03-21 14:14:42', '2018-03-21 14:14:42');
...
CREATE TABLE `yhyg_zuji`  (
  ...
  `mid` int(11) NOT NULL,
  `gid` int(11) NOT NULL,
  `addtime` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
